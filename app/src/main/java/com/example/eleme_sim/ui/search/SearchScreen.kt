        ...
        TopSearchBar(
            ...
            onSearchClicked = {
                if (searchText.isNotBlank()) {
                    ...
                    navController.navigate(com.example.eleme_sim.navigation.Screen.SearchResult.createRoute(searchText))
                }
            },
            onBackClicked = {
                ...
                item {
                    SearchSuggestions(
                        ...
                        onSuggestionClick = { suggestion ->
                            ...
                            navController.navigate(com.example.eleme_sim.navigation.Screen.SearchResult.createRoute(suggestion))
                        }
                    )
                }
            }
                ...
                item {
                    SearchHistory(
                        ...
                        onHistoryItemClick = { keyword ->
                            ...
                            navController.navigate(com.example.eleme_sim.navigation.Screen.SearchResult.createRoute(keyword))
                        },
                        onClearClick = {
            ...
            item {
                SearchDiscovery(
                    ...
                    onStoreClick = { storeName ->
                        ...
                        navController.navigate(com.example.eleme_sim.navigation.Screen.SearchResult.createRoute(storeName))
                    }
                )
            }
